...
export type RouterRequestFactory<T> = (req: T, paramFn: <U extends string>(path: string) => Params<U>) => RouterRequest
...
export type RouterRequest<TParams extends Params<any>=any, TQuery extends ALBEvent["queryStringParameters"]=any, TBody extends object=any> = {
    params: TParams,
    path: string,
    query: TQuery,
    body?: TBody,
